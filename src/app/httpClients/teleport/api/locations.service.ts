...
export class LocationsService {
  ...
  /**
   * Gets geographical features at a location.
   *
   * @param coordinates Latitude (positive for East) and longitude (positive for North) of the location, separated by comma
  ...
  public getLocation(
    ...
    if (coordinates === null || coordinates === undefined) {
      throw new Error(
        'Required parameter coordinates was null or undefined when calling getLocation.'
      );
    }
    ...
    return this.httpClient.get<Location>(
      `${this.basePath}/locations/${encodeURIComponent(String(coordinates))}/`,
      {
