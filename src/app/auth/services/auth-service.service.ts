...
import { AuthParams } from 'src/app/httpClients/travelLogApi/users/schema';
...
export class AuthService {
  ...
  private isAuthenticatedEvent: ReplaySubject<boolean> =
    new ReplaySubject<boolean>(1);

  constructor(
    public jwtHelper: JwtHelperService,
    private httpClient: TravelLogApiHttp
  ) {
